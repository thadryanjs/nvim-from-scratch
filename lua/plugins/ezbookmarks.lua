...
return{
    {
        ...
        config = function()
            ...
            vim.api.nvim_set_keymap("n", "<leader>ba", ":lua require('ezbookmarks').AddBookmark()<CR>",
                { noremap = true, silent = true })

            vim.api.nvim_set_keymap("n", "<leader>br", ":lua require('ezbookmarks').RemoveBookmark()<CR>",
                { noremap = true, silent = true })
            
            vim.api.nvim_set_keymap("n", "<leader>bo", ":lua require('ezbookmarks').OpenBookmark()<CR>",
                { noremap = true, silent = true })
